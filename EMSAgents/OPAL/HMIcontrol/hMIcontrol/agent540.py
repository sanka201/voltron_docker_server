...
#            Message= [{'Threashhold':int(message)},{'k':'Type'}]
            self.vip.pubsub.publish('pubsub', "control/plc/NIRE_WeMo_cc_1/PeakShaver", message=[{'Threashhold':int(message)},{'k':'Type'}])
           # print('BAAAAAAAAAAAAAAAAAAAAAAA')
        elif topic=='Building540/HMIcontrol/ClusterControl/Threshold/cc4':
            print('HAAAAAAAAAAAAAAAAAAAAAA')
#            Message= [{'Threashhold':int(message)},{'k':'Type'}]
            self.vip.pubsub.publish('pubsub', "control/plc/NIRE_WeMo_cc_4/PeakShaver", message=[{'Threashhold':int(message)},{'k':'Type'}])
        elif topic=='Building540/HMIcontrol/ClusterControl/Threshold/a1':
            print('HAAAAAAAAAAAAAAAAAAAAAA')
#            Message= [{'Threashhold':int(message)},{'k':'Type'}]
            self.vip.pubsub.publish('pubsub', "control/plc/NIRE_ALPHA_cc_2/PeakShaver", message=[{'Threashhold':int(message)},{'k':'Type'}])
        elif topic=='Building540/HMIcontrol/ClusterControl/Threshold/a2':
            print('HAAAAAAAAAAAAAAAAAAAAAA')
#            Message= [{'Threashhold':int(message)},{'k':'Type'}]
            self.vip.pubsub.publish('pubsub', "control/plc/NIRE_ALPHA_cc_1/PeakShaver", message=[{'Threashhold':int(message)},{'k':'Type'}])
