...
class Lpcgmagent(Agent):
    ...
    def __init__(self, setting1=1, setting2="some/random/topic",
        ...
        Temp1={}
        Temp2={}
        csv_path='/home/sanka/volttron/OPAL/LPCGMAgent/BuildingsP_Config.csv'
        WeMo_Priorities={}
    ...
    def _handle_publish(self, peer, sender, bus, topic, headers,
        ...
        if x>0:
            ...
            for k in self.loads_consumption:
                ...
                Message={"Main_P":int((message[0])['P1P'])/10,"controllable":self.total_consumption}
          #  Message={"Main_P":self.total_consumption,"status":1}
                topic1='Microgrid/GLEAMM/BuildingP/LPC/all'
                result = self.vip.pubsub.publish(peer='pubsub',topic=topic1, headers=header,message= Message) 
          
        else:
                print('no') 
        print('yyyyyyyyyyyyyyyyyyy', topic,message)

        if topic=='control/plc/BuildingP/shedding':
            ...
            self.event_control_trigger=0
        if topic=='control/plc/BuildingP/directcontrol':
            self.event_control_trigger=1
            Lpcgmagent.Shedding_Command=1
            Lpcgmagent.User_Command=1
            ...
            self.event_control_trigger=0
        if topic=='control/plc/BuildingP/increment':
            self.event_control_trigger=1
    ...
    def Send_Request(self,WeMo,CC):
        ...
        try:
            ...
            tag='CMD'+WeMo
            print('Settting Building loads',self.WeMo_Scheduled_Status[WeMo],tag)
           ...
           # result = self.vip.rpc.call('platform.driver','set_point','Campus1/Banshee1/BEMS_1','CMD_G1',1)
            result=self.vip.rpc.call('platform.driver','set_point', 'Microgrid/GLEAMM/BuildingP',tag,self.WeMo_Scheduled_Status[WeMo]).get(timeout=60)
...
#                return 0
    ...
    def Send_WeMo_Schedule(self):
        ...
        result=self.vip.rpc.call('platform.driver','set_point', 'Microgrid/GLEAMM/BuildingP','CMDPBRK',1).get(timeout=60)
