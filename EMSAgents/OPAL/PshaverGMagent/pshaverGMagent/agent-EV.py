    ...
    def PeakShaver(self):
       ...
       # if self.Peakshaverthreashhold >=0 :
        ...
        if (self.Threshour==self.simhour):
            if self.Threshour <= 4000
                      result=agent.vip.rpc.call('platform.driver','set_point', 'Microgrid/GLEAMM/RTACHREXTRA' ,'Profile_option',2)
                      time.sleep(1)
                      result=agent.vip.rpc.call('platform.driver','set_point', 'Microgrid/GLEAMM/RTACHREXTRA' ,'Optype_EV',1)
            elif self.Threshour > 4000 self.Threshour <= 8000:
                      result=agent.vip.rpc.call('platform.driver','set_point', 'Microgrid/GLEAMM/RTACHREXTRA' ,'Profile_option',1)
                      time.sleep(1)
                      result=agent.vip.rpc.call('platform.driver','set_point', 'Microgrid/GLEAMM/RTACHREXTRA' ,'Optype_EV',1)
            elif self.Threshour > 8000 self.Threshour <= 12000:
                      result=agent.vip.rpc.call('platform.driver','set_point', 'Microgrid/GLEAMM/RTACHREXTRA' ,'Profile_option',0)
                      time.sleep(1)
                      result=agent.vip.rpc.call('platform.driver','set_point', 'Microgrid/GLEAMM/RTACHREXTRA' ,'Optype_EV',1)
